...
// Same tokens as the desktop app (apps/desktop/src/theme.ts) so the two read
// as one product; only the page-level rules differ, since this is a normal
// scrolling web page rather than a fixed app window.
