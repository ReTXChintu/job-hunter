      ...
      body: ListView(
        children: [
          ...
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 16),
            child: Text(
              'This app only reviews and approves work your desktop agent already prepared. No AI runs here and no data is stored anywhere except your own relay and this phone.',
